...
/**
 * Base class that represents a row from the 'address.country' table.
 *
 *
 *
 * @package    propel.generator.address.Base
 */
abstract class Country implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CountryTableMap';
    ...
    /**
     * Initializes internal state of Base\Country object.
     */
     ...
     * @return $this|\Country The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Country'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO address.country (%s) VALUES (%s)',
