...
/**
 * Base class that represents a query for the 'address.country' table.
 *
 *
 *
...
abstract class CountryQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'address', $modelName = '\\Country', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, country_name FROM address.country WHERE id = :p0';
        try {
