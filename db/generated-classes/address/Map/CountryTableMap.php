...
/**
 * This class defines the structure of the 'address.country' table.
 *
 *
 *
...
class CountryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'address.Map.CountryTableMap';

    /**
     * The default database name for this class
     */
    const DATABASE_NAME = 'address';

    /**
     * The table name for this class
     */
    const TABLE_NAME = 'address.country';
     ...
     */
    const CLASS_DEFAULT = 'address.Country';
     ...
     */
    const COL_ID = 'address.country.id';

    /**
     * the column name for the country_name field
     */
    const COL_COUNTRY_NAME = 'address.country.country_name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'CountryName', ),
        self::TYPE_CAMELNAME     => array('id', 'countryName', ),
        self::TYPE_COLNAME       => array(CountryTableMap::COL_ID, CountryTableMap::COL_COUNTRY_NAME, ),
        self::TYPE_FIELDNAME     => array('id', 'country_name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'CountryName' => 1, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'countryName' => 1, ),
        self::TYPE_COLNAME       => array(CountryTableMap::COL_ID => 0, CountryTableMap::COL_COUNTRY_NAME => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'country_name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    {
        // attributes
        $this->setName('address.country');
        $this->setPhpName('Country');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\Country');
        $this->setPackage('address');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('country_name', 'CountryName', 'VARCHAR', true, 255, null);
    } // initialize()
    ...
    /**
     * Deletes all rows from the address.country table.
     *
     * @param ConnectionInterface $con the connection to use
