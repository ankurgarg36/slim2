...
/**
 * Base class that represents a row from the 'articles.articles' table.
 *
 *
 *
...
abstract class Articles implements ActiveRecordInterface
{
    ...
    public function setAuthorId($v)
    {
        ...
        if ($this->author_id !== $v) {
            $this->author_id = $v;
            $this->modifiedColumns[ArticlesTableMap::COL_AUTHOR_ID] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== null || $dt !== null) {
            if ($this->date === null || $dt === null || $dt->format("Y-m-d") !== $this->date->format("Y-m-d")) {
                ...
                $this->modifiedColumns[ArticlesTableMap::COL_DATE] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ArticlesTableMap::translateFieldName('AuthorId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ArticlesTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = ArticlesTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ArticlesTableMap::COL_AUTHOR_ID)) {
        ...
        if ($this->isColumnModified(ArticlesTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }

        $sql = sprintf(
            'INSERT INTO articles.articles (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ArticlesTableMap::COL_AUTHOR_ID)) {
            $criteria->add(ArticlesTableMap::COL_AUTHOR_ID, $this->author_id);
        }
        if ($this->isColumnModified(ArticlesTableMap::COL_TITLE)) {
        ...
        if ($this->isColumnModified(ArticlesTableMap::COL_DATE)) {
            $criteria->add(ArticlesTableMap::COL_DATE, $this->date);
        }
    ...
    public function getAuthor(ConnectionInterface $con = null)
    {
        if ($this->aAuthor === null && ($this->author_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aAuthor->addArticless($this);
             */
        }
    ...
    {
        if (null !== $this->aAuthor) {
            $this->aAuthor->removeArticles($this);
        }
        $this->id = null;
        $this->author_id = null;
        $this->title = null;
    ...
    static public function loadValidatorMetadata(ClassMetadata $metadata)
    {
        ...
        $metadata->addPropertyConstraint('author_id', new NotNull());
    }
