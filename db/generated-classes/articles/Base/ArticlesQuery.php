...
/**
 * Base class that represents a query for the 'articles.articles' table.
 *
 *
 *
 * @method     ChildArticlesQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildArticlesQuery orderByAuthorId($order = Criteria::ASC) Order by the author_id column
 ...
 * @method     ChildArticlesQuery orderByDate($order = Criteria::ASC) Order by the date column
 *
 * @method     ChildArticlesQuery groupById() Group by the id column
 * @method     ChildArticlesQuery groupByAuthorId() Group by the author_id column
 ...
 * @method     ChildArticlesQuery groupByDate() Group by the date column
 *
 ...
 *
 * @method     ChildArticlesQuery leftJoinAuthor($relationAlias = null) Adds a LEFT JOIN clause to the query using the Author relation
 * @method     ChildArticlesQuery rightJoinAuthor($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Author relation
 * @method     ChildArticlesQuery innerJoinAuthor($relationAlias = null) Adds a INNER JOIN clause to the query using the Author relation
 *
 * @method     ChildArticlesQuery joinWithAuthor($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Author relation
 *
 * @method     ChildArticlesQuery leftJoinWithAuthor() Adds a LEFT JOIN clause and with to the query using the Author relation
 * @method     ChildArticlesQuery rightJoinWithAuthor() Adds a RIGHT JOIN clause and with to the query using the Author relation
 * @method     ChildArticlesQuery innerJoinWithAuthor() Adds a INNER JOIN clause and with to the query using the Author relation
 *
 * @method     \AuthorQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildArticles findOneByAuthorId(int $author_id) Return the first ChildArticles filtered by the author_id column
 ...
 * @method     ChildArticles findOneByDate(string $date) Return the first ChildArticles filtered by the date column *
 ...
 * @method     ChildArticles requireOneByAuthorId(int $author_id) Return the first ChildArticles filtered by the author_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildArticles requireOneByDate(string $date) Return the first ChildArticles filtered by the date column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildArticles[]|ObjectCollection findByAuthorId(int $author_id) Return ChildArticles objects filtered by the author_id column
 ...
 * @method     ChildArticles[]|ObjectCollection findByDate(string $date) Return ChildArticles objects filtered by the date column
...
protected $entityNotFoundExceptionClass = '\\Propel\\Runtime\\Exception\\EntityNotFoundException';
     ...
     */
    public function __construct($dbName = 'articles', $modelName = '\\Articles', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, author_id, title, url, date FROM articles.articles WHERE id = :p0';
        try {
    ...
    public function filterByAuthorId($authorId = null, $comparison = null)
    {
        if (is_array($authorId)) {
            ...
            if (isset($authorId['min'])) {
                $this->addUsingAlias(ArticlesTableMap::COL_AUTHOR_ID, $authorId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($authorId['max'])) {
                $this->addUsingAlias(ArticlesTableMap::COL_AUTHOR_ID, $authorId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ArticlesTableMap::COL_AUTHOR_ID, $authorId, $comparison);
    }
    ...
    public function filterByDate($date = null, $comparison = null)
    {
        if (is_array($date)) {
            $useMinMax = false;
            if (isset($date['min'])) {
                $this->addUsingAlias(ArticlesTableMap::COL_DATE, $date['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($date['max'])) {
                $this->addUsingAlias(ArticlesTableMap::COL_DATE, $date['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ArticlesTableMap::COL_DATE, $date, $comparison);
    }
    ...
    public function filterByAuthor($author, $comparison = null)
    {
        if ($author instanceof \Author) {
            return $this
                ->addUsingAlias(ArticlesTableMap::COL_AUTHOR_ID, $author->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(ArticlesTableMap::COL_AUTHOR_ID, $author->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    /**
     * Deletes all rows from the articles.articles table.
     *
    ...
    public function doSelect(ConnectionInterface $con = null)
    {
        ...
        $db = Propel::getServiceContainer()->getAdapter(ArticlesTableMap::DATABASE_NAME);
