...
/**
 * Base class that represents a row from the 'articles.author' table.
 *
 *
 *
...
abstract class Author implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AuthorTableMap::translateFieldName('AuthorName', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO articles.author (%s) VALUES (%s)',
    ...
    public function setArticless(Collection $articless, ConnectionInterface $con = null)
    {
        ...
        foreach ($articlessToDelete as $articlesRemoved) {
            $articlesRemoved->setAuthor(null);
        }
    ...
    public function removeArticles(ChildArticles $articles)
    {
        if ($this->getArticless()->contains($articles)) {
            ...
            $this->articlessScheduledForDeletion[]= clone $articles;
    ...
    {
        $metadata->addPropertyConstraint('author_name', new NotNull());
    }
