...
/**
 * Base class that represents a query for the 'articles.author' table.
 *
 *
 *
 * @method     ChildAuthorQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildAuthorQuery orderByAuthorName($order = Criteria::ASC) Order by the author_name column
 *
 * @method     ChildAuthorQuery groupById() Group by the id column
 * @method     ChildAuthorQuery groupByAuthorName() Group by the author_name column
 *
 ...
 *
 * @method     ChildAuthorQuery leftJoinArticles($relationAlias = null) Adds a LEFT JOIN clause to the query using the Articles relation
 * @method     ChildAuthorQuery rightJoinArticles($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Articles relation
 * @method     ChildAuthorQuery innerJoinArticles($relationAlias = null) Adds a INNER JOIN clause to the query using the Articles relation
 *
 * @method     ChildAuthorQuery joinWithArticles($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Articles relation
 *
 * @method     ChildAuthorQuery leftJoinWithArticles() Adds a LEFT JOIN clause and with to the query using the Articles relation
 * @method     ChildAuthorQuery rightJoinWithArticles() Adds a RIGHT JOIN clause and with to the query using the Articles relation
 * @method     ChildAuthorQuery innerJoinWithArticles() Adds a INNER JOIN clause and with to the query using the Articles relation
 *
 ...
 * @method     ChildAuthor findOneByAuthorName(string $author_name) Return the first ChildAuthor filtered by the author_name column *
 ...
 * @method     ChildAuthor requireOneByAuthorName(string $author_name) Return the first ChildAuthor filtered by the author_name column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildAuthor[]|ObjectCollection findByAuthorName(string $author_name) Return ChildAuthor objects filtered by the author_name column
...
abstract class AuthorQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'articles', $modelName = '\\Author', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, author_name FROM articles.author WHERE id = :p0';
        try {
    ...
    public function filterByAuthorName($authorName = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(AuthorTableMap::COL_AUTHOR_NAME, $authorName, $comparison);
    }
    ...
    public function filterByArticles($articles, $comparison = null)
    {
        if ($articles instanceof \Articles) {
            return $this
                ->addUsingAlias(AuthorTableMap::COL_ID, $articles->getAuthorId(), $comparison);
     ...
     * @return $this|ChildAuthorQuery The current query, for fluid interface
     */
    public function joinArticles($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
     ...
     */
    public function useArticlesQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
    ...
    /**
     * Deletes all rows from the articles.author table.
     *
