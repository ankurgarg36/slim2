...
/**
 * This class defines the structure of the 'articles.articles' table.
 *
 *
 *
...
class ArticlesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'articles.Map.ArticlesTableMap';
     ...
     */
    const TABLE_NAME = 'articles.articles';
     ...
     */
    const CLASS_DEFAULT = 'articles.Articles';
     ...
     */
    const COL_ID = 'articles.articles.id';

    /**
     * the column name for the author_id field
     */
    const COL_AUTHOR_ID = 'articles.articles.author_id';

    /**
     * the column name for the title field
     */
    const COL_TITLE = 'articles.articles.title';

    /**
     * the column name for the url field
     */
    const COL_URL = 'articles.articles.url';

    /**
     * the column name for the date field
     */
    const COL_DATE = 'articles.articles.date';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'AuthorId', 'Title', 'Url', 'Date', ),
        self::TYPE_CAMELNAME     => array('id', 'authorId', 'title', 'url', 'date', ),
        self::TYPE_COLNAME       => array(ArticlesTableMap::COL_ID, ArticlesTableMap::COL_AUTHOR_ID, ArticlesTableMap::COL_TITLE, ArticlesTableMap::COL_URL, ArticlesTableMap::COL_DATE, ),
        self::TYPE_FIELDNAME     => array('id', 'author_id', 'title', 'url', 'date', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'AuthorId' => 1, 'Title' => 2, 'Url' => 3, 'Date' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'authorId' => 1, 'title' => 2, 'url' => 3, 'date' => 4, ),
        self::TYPE_COLNAME       => array(ArticlesTableMap::COL_ID => 0, ArticlesTableMap::COL_AUTHOR_ID => 1, ArticlesTableMap::COL_TITLE => 2, ArticlesTableMap::COL_URL => 3, ArticlesTableMap::COL_DATE => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'author_id' => 1, 'title' => 2, 'url' => 3, 'date' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    {
        // attributes
        $this->setName('articles.articles');
        ...
        $this->addForeignKey('author_id', 'AuthorId', 'INTEGER', 'articles.author', 'id', true, null, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ArticlesTableMap::COL_AUTHOR_ID);
            $criteria->addSelectColumn(ArticlesTableMap::COL_TITLE);
            $criteria->addSelectColumn(ArticlesTableMap::COL_URL);
            $criteria->addSelectColumn(ArticlesTableMap::COL_DATE);
        } else {
