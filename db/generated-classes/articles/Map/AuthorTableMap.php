...
/**
 * This class defines the structure of the 'articles.author' table.
 *
 *
 *
...
class AuthorTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'articles.Map.AuthorTableMap';
     ...
     */
    const TABLE_NAME = 'articles.author';
     ...
     */
    const CLASS_DEFAULT = 'articles.Author';
     ...
     */
    const COL_ID = 'articles.author.id';

    /**
     * the column name for the author_name field
     */
    const COL_AUTHOR_NAME = 'articles.author.author_name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'AuthorName', ),
        self::TYPE_CAMELNAME     => array('id', 'authorName', ),
        self::TYPE_COLNAME       => array(AuthorTableMap::COL_ID, AuthorTableMap::COL_AUTHOR_NAME, ),
        self::TYPE_FIELDNAME     => array('id', 'author_name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'AuthorName' => 1, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'authorName' => 1, ),
        self::TYPE_COLNAME       => array(AuthorTableMap::COL_ID => 0, AuthorTableMap::COL_AUTHOR_NAME => 1, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'author_name' => 1, ),
        self::TYPE_NUM           => array(0, 1, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('author_name', 'AuthorName', 'VARCHAR', true, 255, null);
    } // initialize()
  ...
  array (
    ...
    {
        return array(
            'validate' => array('rule1' => array ('column' => 'author_name','validator' => 'NotNull',), ),
        );
    } // getBehaviors()
