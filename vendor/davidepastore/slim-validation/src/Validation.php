...
class Validation
{
    ...
    /**
     * takes the array of params as key=>value
     * like [
     *          'name'=>'hello',
     *          'email'=>'abc@xyx.com'
     *      ]
     * and validate each value as per rule/validators called in constructor of this class
     * @param $params
     *
     * @return bool
     */
    public function _validate($params){
        $this->errors = [];
        $this->validate($params, $this->validators);
